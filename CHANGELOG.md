...
## [1.19.0](https://github.com/im-anishraj/arnio/compare/v1.18.0...v1.19.0) (2026-05-28)
...
* add ArFrame._repr_html_() for notebook-friendly display ([3674749](https://github.com/im-anishraj/arnio/commit/3674749704a0a70aab717229892e71c3529b8202))
...
* add clean_column_names helper ([0c520e6](https://github.com/im-anishraj/arnio/commit/0c520e6e414be1fd40b6840b0a05ae01e0d36c4f))
* add columns_with_empty_strings to DataQualityReport.summary() ([#1207](https://github.com/im-anishraj/arnio/issues/1207)) ([f5a3e68](https://github.com/im-anishraj/arnio/commit/f5a3e6821267ee9046e5784e0ba2407e1bead361))
...
* add from_dict conversion helper ([195fa84](https://github.com/im-anishraj/arnio/commit/195fa84b731df8439f5a289fc57d757aad58f709))
* add max_suggestions to data quality report exports ([aef993f](https://github.com/im-anishraj/arnio/commit/aef993ff012e9cd1ee23ed6f69fa6e7151f4131b))
...
* add quality report export helpers ([0de34b9](https://github.com/im-anishraj/arnio/commit/0de34b9bf8804d6b49c4d659883051a7b7c9bc44))
* add unregister_step for custom pipeline steps ([#1004](https://github.com/im-anishraj/arnio/issues/1004)) ([7c154cd](https://github.com/im-anishraj/arnio/commit/7c154cd33f4050a2c2e1bf3c3a4b637fc4ab9b38))
...
* export schema summaries from frames ([f36b0d8](https://github.com/im-anishraj/arnio/commit/f36b0d8e0447d9ccf4fb2d7c5d0a183580aafd57))
...
* **pandas:** expose auto_clean explain mode ([0ab340b](https://github.com/im-anishraj/arnio/commit/0ab340b54991771f6257301912b469ed7afa5db9))
...
* **schema:** add TimeZone validator ([f449089](https://github.com/im-anishraj/arnio/commit/f449089c9fd0eb71592fb4554d8ea270329da03e))
* support ordered sequences for coalesce_columns subset ([9b1a02b](https://github.com/im-anishraj/arnio/commit/9b1a02be5118825d2231fda794aa755fc9cd9580))
* support pandas input in drop_constant_columns ([797d4e7](https://github.com/im-anishraj/arnio/commit/797d4e7c7affbbe5af8b51ab87e361fc12a6e2b7))
...
* **a11y:** add missing aria-label to mobile-menu on all pages ([#1723](https://github.com/im-anishraj/arnio/issues/1723)) ([7447d91](https://github.com/im-anishraj/arnio/commit/7447d91adb3edc3d0433209cea256c1b52cc2abe))
...
* add footer link hover and focus states ([025de45](https://github.com/im-anishraj/arnio/commit/025de454847cd62d5bffa8a1103ab250c41a5620))
* **api:** reject all-column drops consistently ([180d831](https://github.com/im-anishraj/arnio/commit/180d831a3aebde8466b70b36a3aab6752412898e))
* **ci:** clarify aggregate wheel matrix status ([cbf696f](https://github.com/im-anishraj/arnio/commit/cbf696f8e14214541439e46099ed751a0ca1e27f))
* **cleaning:** add strict boolean validation for clean() parameters ([#1476](https://github.com/im-anishraj/arnio/issues/1476)) ([43b6afd](https://github.com/im-anishraj/arnio/commit/43b6afd8a56e070ea3e695f320fd7a0064858d2a))
...
* **cleaning:** validate normalize_case case_type ([a68ee74](https://github.com/im-anishraj/arnio/commit/a68ee748cda44993e7c016533d2e8ad4002ac882))
* **cleaning:** validate scalar comparison values in filter_rows ([9bacf70](https://github.com/im-anishraj/arnio/commit/9bacf708d1f869ccb34bf396bef362f899d0da12))
* **csv:** align sniff_delimiter corruption handling with read_csv ([aa41bee](https://github.com/im-anishraj/arnio/commit/aa41bee95a1eac1902882edfd9cfe6aae46afd0c))
* **csv:** do not apply encoding twice for text file-like inputs ([#1736](https://github.com/im-anishraj/arnio/issues/1736)) ([13574ee](https://github.com/im-anishraj/arnio/commit/13574ee5679861597b57d876a80d4b7735b7200c)), closes [#1663](https://github.com/im-anishraj/arnio/issues/1663)
* gate Catch2 behind native test option ([#1771](https://github.com/im-anishraj/arnio/issues/1771)) ([c96cf60](https://github.com/im-anishraj/arnio/commit/c96cf60b0e4d6219532f6c06ba38a45bf232060a))
* handle non-string pandas labels in drop_columns_matching ([f96b5fc](https://github.com/im-anishraj/arnio/commit/f96b5fc7f7d60810ea19e0a5e620c20b3afc26ba))
...
* ignore strip whitespace benchmark artifact ([9c87c0d](https://github.com/im-anishraj/arnio/commit/9c87c0de8007b27ef4d94450ac8f079b4f376c6f))
* improve compare_profiles schema mismatch guidance ([8bc5811](https://github.com/im-anishraj/arnio/commit/8bc5811adf2906b9a3abfeb5cebcfa70c6f6e9ed))
* improve dark mode logo visibility ([#1482](https://github.com/im-anishraj/arnio/issues/1482)) ([b76db1b](https://github.com/im-anishraj/arnio/commit/b76db1bff48c996a8cde783c3f89b3adc565076d))
* **io:** add skiprows alias to read_csv_chunked for API consistency ([#1749](https://github.com/im-anishraj/arnio/issues/1749)) ([53fbf71](https://github.com/im-anishraj/arnio/commit/53fbf712fb50df2aefef2d8b24c3b0e98dfd51d4))
* **io:** detect duplicate keys in read_jsonl rows ([#1780](https://github.com/im-anishraj/arnio/issues/1780)) ([d0d7a61](https://github.com/im-anishraj/arnio/commit/d0d7a61efbf7bef1cad93f3b2bf41c3d59ef9a11))
* **jsonl:** validate encoding before opening files ([525138b](https://github.com/im-anishraj/arnio/commit/525138b587fe547d899de175a9da1c6cabd91c3e))
* make GitHub contributor widget resilient ([3effb34](https://github.com/im-anishraj/arnio/commit/3effb34c072a4d6c675e7e26bbbb5ea371e6cff7))
* normalize recursive schema export values ([5adca74](https://github.com/im-anishraj/arnio/commit/5adca74ecc04a5712ddb66dd4275f93bbd7e19d7))
* normalize whitespace-wrapped null tokens ([#1322](https://github.com/im-anishraj/arnio/issues/1322)) ([86ce6fe](https://github.com/im-anishraj/arnio/commit/86ce6fe66c4835d7230d7121f746c82dcdda36a1))
* **pandas:** add max_errors passthrough to ArnioPandasAccessor.validate ([#1739](https://github.com/im-anishraj/arnio/issues/1739)) ([be158fe](https://github.com/im-anishraj/arnio/commit/be158fe9c9e14a89f215ca7b766d1c6380aa969b))
* pipeline dry_run validates intermediate frame ([e60ab6d](https://github.com/im-anishraj/arnio/commit/e60ab6dd4f6f33f020531625966fea1e537e9a23))
* preserve deferred schema inference for all-null chunked columns ([#1743](https://github.com/im-anishraj/arnio/issues/1743)) ([d8f983f](https://github.com/im-anishraj/arnio/commit/d8f983ff62580513e30548fdbc4ce2fb57a43a25))
* **quality:** add redaction options to ProfileComparison.to_dict and to_json ([#1775](https://github.com/im-anishraj/arnio/issues/1775)) ([fea4821](https://github.com/im-anishraj/arnio/commit/fea48212fbfa0ab5956221295fdf5cb1cb8bfe7d))
* **quality:** properly filter nested cast_types mapping for exclude_columns ([6cec648](https://github.com/im-anishraj/arnio/commit/6cec6482fffb91cc25fe339ae4c31bda072c655a))
* **quality:** redact top values in profile exports ([62036ec](https://github.com/im-anishraj/arnio/commit/62036ec85ba53232b69d5814bb07d42ffe41fc4b))
* quote numeric-looking strings in schema_to_yaml ([f5899d2](https://github.com/im-anishraj/arnio/commit/f5899d2196d17f0bc0bd8d39135a4f1eb155b4f9))
* raise TypeError for unsupported fill_nulls values ([4b0facd](https://github.com/im-anishraj/arnio/commit/4b0facde6f727c8cdfe254de6576578a9da2b28c))
* recursively normalize nested sets during schema export ([#1521](https://github.com/im-anishraj/arnio/issues/1521)) ([7daf2f5](https://github.com/im-anishraj/arnio/commit/7daf2f52d160e30d02ab990d5350d66b9abc184c))
* redact excluded columns from quality suggestions ([e74d4fa](https://github.com/im-anishraj/arnio/commit/e74d4fa4abf0d756bdbdc0eeae57da008e690975))
...
* reject bare strings in parse_bool_strings token sets ([4d75d31](https://github.com/im-anishraj/arnio/commit/4d75d31f7caf5dadbd036f29bf54ef3e0fdc4b91))
* reject duplicate columns in schema unique constraints ([#1774](https://github.com/im-anishraj/arnio/issues/1774)) ([9aa75a0](https://github.com/im-anishraj/arnio/commit/9aa75a0a2ab28f05023f53ad35e5c54c1920a7f1))
...
* reject non-boolean schema field flags ([3744332](https://github.com/im-anishraj/arnio/commit/3744332862e3e03ac463767d8a0a36d5233351a6))
* restrict CurrencyCode to ISO 4217 values ([39ef187](https://github.com/im-anishraj/arnio/commit/39ef187ff776ff852f16ba720de332c5c601ad44))
* schema export no longer drops fields named strict or unique ([6d8128a](https://github.com/im-anishraj/arnio/commit/6d8128ae33d8ae649394bc0d6f111b9bd2cc43ff))
* **schema:** normalize custom validator return values to prevent pd.N… ([84c0011](https://github.com/im-anishraj/arnio/commit/84c001123df778f10a558bc37553d67456197324))
* **schema:** reject bare string allowed values ([53b30f4](https://github.com/im-anishraj/arnio/commit/53b30f441acfb13cd9ad004c2052ca27a6e152d1))
* **schema:** reject non-boolean strict values ([f918ef3](https://github.com/im-anishraj/arnio/commit/f918ef373cba8cd74b593b34afa7bbccf312f958))
* **schema:** validate numeric min/max types ([5d98877](https://github.com/im-anishraj/arnio/commit/5d988771df35d5d3f97d0bc3aea397942abc141a))
...
* short-circuit read_jsonl nrows zero ([d5bf3cb](https://github.com/im-anishraj/arnio/commit/d5bf3cb2ce4550c8ce1f071cf59affb4b42f1fd0))
* **sklearn:** validate ArnioCleaner boolean options ([39482bd](https://github.com/im-anishraj/arnio/commit/39482bdf25cfd43dfd2dbf35900d673879ea596f))
* stabilize website navbar layout ([#1425](https://github.com/im-anishraj/arnio/issues/1425)) ([a162d61](https://github.com/im-anishraj/arnio/commit/a162d610488df94e4b8c103ff8be98d1464ffc7e))
* **stubs:** correct Frame.dtypes() return type to dict[str, str] Closes [#1649](https://github.com/im-anishraj/arnio/issues/1649) ([#1725](https://github.com/im-anishraj/arnio/issues/1725)) ([ebeb60f](https://github.com/im-anishraj/arnio/commit/ebeb60f6c21d851032abe6530019693ad0e3f93d))
* surface duplicate header rejection as CsvReadError ([#1370](https://github.com/im-anishraj/arnio/issues/1370)) ([8d226b2](https://github.com/im-anishraj/arnio/commit/8d226b2f14dec7097b08906b200a9e1883e63029))
* validate auto_clean return_report boolean ([451a74e](https://github.com/im-anishraj/arnio/commit/451a74eac66e9864f6ed351c3676ea405cf86e1f))
* validate benchmark CLI numeric arguments ([27b7b8f](https://github.com/im-anishraj/arnio/commit/27b7b8fcacb5057990fb12abfa8c3f3d117aa1cf))
* validate clip_numeric bound types ([cc34a2e](https://github.com/im-anishraj/arnio/commit/cc34a2e61c2eda06f5552522b25bf86ba952eda1))
* validate clip_numeric subset before native execution ([5e89a48](https://github.com/im-anishraj/arnio/commit/5e89a48c982532121726e5827a472b4b4e9f7b59))
...
* validate CSV encoding type ([b3c2a9e](https://github.com/im-anishraj/arnio/commit/b3c2a9e8ab2d7c27b876ecad4b57ec4dabd94db1))
* validate duckdb connection before registration ([14d423c](https://github.com/im-anishraj/arnio/commit/14d423c35817f9bd363671666595be681bc92162))
* validate file_path type in DataQualityReport.to_html ([e9719e0](https://github.com/im-anishraj/arnio/commit/e9719e0fe1e68f6c2fe054f947edd6046f7f2c56))
* validate non-string field names in schema ([8f58b2a](https://github.com/im-anishraj/arnio/commit/8f58b2ae7b6d06daad10a5e0f0a3aac7eba5f4b7))
* validate pipeline boolean options ([0e69947](https://github.com/im-anishraj/arnio/commit/0e69947e76723fc875d6a103c38ff05649d71a5f))
* validate pipeline frame input ([ba2f27e](https://github.com/im-anishraj/arnio/commit/ba2f27eadf66ab49085da4a0bdded82156a06273))
* validate profile exclude columns before length checks ([c8e862d](https://github.com/im-anishraj/arnio/commit/c8e862df8c41740cf3d6bbb183c5bd7b760d0051))
* validate redact_sample_values input ([f03708d](https://github.com/im-anishraj/arnio/commit/f03708d0db7c283a8fd12bb6b854e8601cb2d0e5))
* validate required_if schema rule shape ([e363800](https://github.com/im-anishraj/arnio/commit/e3638001fef3a7e43a52cc6e8115a293c69b0eba))
* validate scan_csv has_header boolean ([cb8aee6](https://github.com/im-anishraj/arnio/commit/cb8aee605a7da61911d3c4e41baf0edb2569a6f2))
* validate schema rules during construction ([67d75dc](https://github.com/im-anishraj/arnio/commit/67d75dcb5d3255b1bb854466e7cbc5b631e919c7))
* validate unequal column lengths in from_dict ([#1760](https://github.com/im-anishraj/arnio/issues/1760)) ([c7a5884](https://github.com/im-anishraj/arnio/commit/c7a5884cf01e5faa93f4b6a9dfdf3dfbc0fe3f64))
* **website:** correct docs sidebar active section tracking ([5c95cad](https://github.com/im-anishraj/arnio/commit/5c95cad7586cce822b76a87a52d001c8a0cbc836))
* **website:** load all contributors ([28e2196](https://github.com/im-anishraj/arnio/commit/28e21961e2a02022aeb3725745deebb7addc8762))


### Performance Improvements

* avoid full pandas materialization in head and tail ([#1480](https://github.com/im-anishraj/arnio/issues/1480)) ([a89edc0](https://github.com/im-anishraj/arnio/commit/a89edc0a8b32a5a3e672c249822612e82cf652db))
...
* **cleaning:** optimize drop_duplicates hashing ([fe2f882](https://github.com/im-anishraj/arnio/commit/fe2f882a4154901ce221243c45a7fe3f9ff2f66f))
* populate benchmark baselines ([7e2c8a5](https://github.com/im-anishraj/arnio/commit/7e2c8a538a01c76ad9df73655ba242836eb76af3))
* stream CSV rows to reduce peak read memory ([b2be45e](https://github.com/im-anishraj/arnio/commit/b2be45e09775cabd03bc4900b602db2ccd2443a6))
...
* add missing public and helper docstrings ([7c36b8d](https://github.com/im-anishraj/arnio/commit/7c36b8dbf94979faf9cb9867ccb024009a2bb609))
* add nullable pandas extension dtype round-trip compatibility se… ([#1268](https://github.com/im-anishraj/arnio/issues/1268)) ([e2e8fda](https://github.com/im-anishraj/arnio/commit/e2e8fda4e0ca2820f617813e26f1e39a26ca7282))
* add root code of conduct ([6d8438b](https://github.com/im-anishraj/arnio/commit/6d8438b8c6191194bce6bf063266019a51643f92))
...
* add website social preview metadata ([7640941](https://github.com/im-anishraj/arnio/commit/764094198a75a30c0ac6a320189fed9e847e1306))
* add Windows-compatible pytest commands to PR template ([#1217](https://github.com/im-anishraj/arnio/issues/1217)) ([fffe6b3](https://github.com/im-anishraj/arnio/commit/fffe6b33d6de6e641aa9af15519dacd1fb2a2ccf))
* add winsorize_outliers example ([e9ee611](https://github.com/im-anishraj/arnio/commit/e9ee6114323214cf2393fd8ca825ff8d9d4a7a8e))
...
* update website link ([013f05e](https://github.com/im-anishraj/arnio/commit/013f05e060f6785e508a3367f949f80cea6cd216))
